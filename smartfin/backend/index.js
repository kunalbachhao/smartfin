...
// ── Financial API routes (JWT-protected) ──────────────────────────────────
...
const server = app.listen(PORT, "0.0.0.0", () => {
  ...
  console.log("  GET    /transactions         - List transactions (paginated)");
  ...
  console.log("  GET    /analytics            - Computed analytics");
  console.log("================================================\n");
});
